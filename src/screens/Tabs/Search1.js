import { View, Text,StyleSheet, Image, Touchable ,TextInput,Dimensions} from "react-native";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchView}>
        ...
        <TextInput value={search} onChangeText={txt=>{setSearch(txt);filterData(txt);}} placeholder="Search items here..." style={styles.input}/>
        </View>
        {search!=='' && (
        ...
        <Image source={require('../../images/close.png')} style={[styles.icon,{width:20,height:20}] }/>
        </TouchableOpacity>)}
